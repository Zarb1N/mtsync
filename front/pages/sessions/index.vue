  ...
  <div class="sessions">
    <h1>Пространства</h1>
		<Input 
			...
			:placeholder="'Поиск'"
			:icon="'magnifier.light-gray'"
		/>
		<div class="sessions__existing section">
      <h2 class="section__title">Рекомендации для вас</h2>
      <div 
        class="sessions__items"
        v-if="sessionStore.allSessions?.length"
      >
        <SessionCard 
      ...
      <div v-else>Увы, сейчас нет открытых комнат</div>
    </div>
  </div>
</template>
